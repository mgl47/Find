...
function Priv({ Navigation }) {
  return (
    <ScrollView>
      ...
      >
        Privacy Policy ============== Last updated: May 04, 2022 This Privacy
        ...
        Generator](https://www.freeprivacypolicy.com/free-privacy-
        policy-generator/). Interpretation and Definitions
        ...
        authority. * Application means the software program provided by the
        Company downloaded by You on any electronic device, named Find * Company
        (referred to as either "the Company", "We", "Us" or "Our" in this
        Agreement) refers to Find. * Country refers to: Poland * Device means
        any device that can access the Service such as a computer, a cellphone
        or a digital tablet. * Personal Data is any information that relates to
        ...
        visit). * You means the individual accessing or using the Service, or
        the company, or other legal entity on behalf of which such individual is
        accessing or using the Service, as applicable. Collecting and Using Your
        Personal Data ======================================= Types of Data
        Collected ----------------------- Personal Data ~~~~~~~~~~~~~ While
        using Our Service, We may ask You to provide Us with certain personally
        identifiable information that can be used to contact or identify You.
        Personally identifiable information may include, but is not limited to:
        * Email address * First name and last name * Usage Data Usage Data
        ...
        access the Service by or through a mobile device. Information Collected
        while Using the Application
        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ While using Our
        Application, in order to provide features of Our Application, We may
        collect, with Your prior permission: * Information regarding your
        location We use this information to provide features of Our Service, to
        ...
        information at any time, through Your Device settings. Use of Your
        Personal Data ------------------------- The Company may use Personal
        ...
        assets transferred. * For other purposes : We may use Your information
        ...
        of Your Personal Data ------------------------------- The Company will
        ...
        of Your Personal Data ------------------------------ Your information,
        ...
        and other personal information. Disclosure of Your Personal Data
        ...
        Other legal requirements ~~~~~~~~~~~~~~~~~~~~~~~~ The Company may
        ...
        and use that information. Links to Other Websites
        ...
        Policy ============================== We may update Our Privacy Policy
        ...
        posted on this page. Contact Us ========== If you have any questions
